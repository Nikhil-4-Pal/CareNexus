...
const ReviewCard = ({ cardTitle, cardContent, imageSrc, btnName }) => {
  return (
    <div className="  relative w-[28rem] h-[28rem]    ">
      <div className="  relative w-full h-full transition-transforms will-change-auto transform-style-3d duration-500 ease-in-out  hover:rotate-y-180">
        ...
        <div className="  absolute w-full h-full backface-hidden flex flex-col justify-center items-center gap-16 rounded-[1.75rem] border-x-2 border-y-2 border-black bg-white p-10 text-center font-Raleway">
