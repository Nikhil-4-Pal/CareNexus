...
function Table() {
  ...
  return (
    <div className='w-full flex justify-center items-center h-screen  bg-blue-400  ' >
      ...
      <div className=' flex flex-col overflow-scroll no-scrollbar  items-center absolute Card min-w-[95%] bg-opacity-100  top-[18%] bg-white /90 font-Raleway  rounded-lg h-[80%] ' >
          ...
          <div className='overflow-y-scroll Cards absolute w-full no-scrollbar gap-12 flex flex-col justify-center items-center top-[35%]  z-20 p-6 ' >
              <Card Name={"AIIMS Delhi"} Bedstatus={"Available"} emergenciesstatus={"Notavailable"} appointmentstatus={"Available"} bgcolor={"green-400"} />
              <Card Name={"AIIMS Delhi"} Bedstatus={"Available"} emergenciesstatus={"Notavailable"} appointmentstatus={"Available"} bgcolor={"green-400"} />
              <Card Name={"AIIMS Delhi"} Bedstatus={"Available"} emergenciesstatus={"Notavailable"} appointmentstatus={"Available"} bgcolor={"green-400"} />
              <Card Name={"AIIMS Delhi"} Bedstatus={"Available"} emergenciesstatus={"Notavailable"} appointmentstatus={"Available"} bgcolor={"green-400"} />
              <Card Name={"AIIMS Delhi"} Bedstatus={"Available"} emergenciesstatus={"Notavailable"} appointmentstatus={"Available"} bgcolor={"green-400"} />
